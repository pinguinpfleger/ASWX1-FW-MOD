...
#define STRING_CONFIG_H_AUTHOR "(Markus H. (FoodFighter / FoFi)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //230V 500W silicone heater original Sidewinder-X1																									  
  #define DEFAULT_bedKp 38.47
  #define DEFAULT_bedKi 6.26
  #define DEFAULT_bedKd 157.59
